...
const AboutFounderComponent = () => {
  return (
    <div className="min-h-screen bg-zinc-200 flex flex-col items-center justify-start font-serif md:py-20">
      ...
      <div className=" bg-zinc-900 rounded-md flex flex-col md:flex-row p-10 max-w-5xl items-center justify-start">
        <Image
          src={AboutImage}
          alt="Alora Bonner"
        ...
        <div className="flex flex-col items-center">
          ...
          <p className=" text-zinc-200 text-center  md:text-3xl max-w-4xl ">
            ...
            molestias eius aut. Quis fuga commodi magni? testing
          </p>
        </div>
      </div>
    </div>
